...
rename_dict <- c(
  ice_r = "Residential",
  ice_enh = "Experienced",
  ice_e1 = "No-dest. preference",
  ice_e2 = "No-dest. preference \n& equalized mobility",
...
vars2plot <- c('Residential', 'Experienced',
               "No-dest. preference", "No-dest. preference \n& equalized mobility")
...
G <- ggarrange(g1, g2, g3, g4, ncol = 2, nrow = 2,
               labels = c('a', 'b', 'c', 'd'))
ggsave(filename = "figures/supporting/fig_a1.png", plot=G,
